...
# programs and dataset in the TextBook

chapter | program | content | data
--- | --- | --- | --- 
1  |  ELEMENTS OF PROGRAMMING  |  DATA
1.1.1  |  [helloworld.py](helloworld.py)  |  Hello, World  |  –
1.1.2  |  [useargument.py](useargument.py)  |  using a command-line argument  |  –
1.2.1  |  [ruler.py](ruler.py)  |  string concatenation example  |  –
1.2.2  |  [intops.py](intops.py)  |  integer operators  |  –
1.2.3  |  [floatops.py](floatops.py)  |  float operators  |  –
1.2.4  |  [quadratic.py](quadratic.py)  |  quadratic formula  |  –
1.2.5  |  [leapyear.py](leapyear.py)  |  leap year  |  –
1.3.1  |  [flip.py](flip.py)  |  flipping a fair coin  |  –
1.3.2  |  [tenhellos.py](tenhellos.py)  |  your first loop  |  –
1.3.3  |  [powersoftwo.py](powersoftwo.py)  |  computing powers of two  |  –
1.3.4  |  [divisorpattern.py](divisorpattern.py)  |  your first nested loops  |  –
1.3.5  |  [harmonic.py](harmonic.py)  |  harmonic numbers  |  –
1.3.6  |  [sqrt.py](sqrt.py)  |  Newton's method  |  –
1.3.7  |  [binary.py](binary.py)  |  converting to binary  |  –
1.3.8  |  [gambler.py](gambler.py)  |  gambler's ruin simulation  |  –
1.3.9  |  [factors.py](factors.py)  |  factoring integers  |  –
1.4.1  |  [sample.py](sample.py)  |  sampling without replacement  |  –
1.4.2  |  [couponcollector.py](couponcollector.py)  |  coupon collector simulation  |  –
1.4.3  |  [primesieve.py](primesieve.py)  |  sieve of Eratosthenes  |  –
1.4.4  |  [selfavoid.py](selfavoid.py)  |  self-avoiding random walks  |  –
1.5.1  |  [randomseq.py](randomseq.py)  |  generating a random sequence  |  –
1.5.2  |  [twentyquestions.py](twentyquestions.py)  |  interactive user input  |  –
1.5.3  |  [average.py](average.py)  |  averaging a stream of numbers  |  –
1.5.4  |  [rangefilter.py](rangefilter.py)  |  a simple filter  |  –
1.5.5  |  [plotfilter.py](plotfilter.py)  |  standard input to draw filter  |  usa.txt  
1.5.6  |  [bouncingball.py](bouncingball.py)  |  bouncing ball  |  –
1.5.7  |  [playthattune.py](playthattune.py)  |  digital signal processing  |  elise.txt  ascale.txt  stairwaytoheaven.txt  entertainer.txt  firstcut.txt  freebird.txt  looney.txt  
1.6.1  |  [transition.py](transition.py)  |  computing the transition matrix  |  small.txt  medium.txt  
1.6.2  |  [randomsurfer.py](randomsurfer.py)  |  simulating a random surfer  |  –
1.6.3  |  [markov.py](markov.py)  |  mixing a Markov chain  |  –
2  |  FUNCTIONS  |  DATA
2.1.1  |  [harmonicf.py](harmonicf.py)  |  harmonic numbers (revisited)  |  –
2.1.2  |  [gauss.py](gauss.py)  |  Gaussian functions  |  –
2.1.3  |  [coupon.py](coupon.py)  |  coupon collector (revisited)  |  –
2.1.4  |  [playthattunedeluxe.py](playthattunedeluxe.py)  |  play that tune (revisited)  |  elise.txt  ascale.txt  stairwaytoheaven.txt  entertainer.txt  firstcut.txt  freebird.txt  looney.txt  
2.2.1  |  [gaussian.py](gaussian.py)  |  Gaussian functions module  |  –
2.2.2  |  [gaussiantable.py](gaussiantable.py)  |  sample Gaussian client  |  –
2.2.3  |  [sierpinski.py](sierpinski.py)  |  Sierpinski triangle  |  –
2.2.4  |  [ifs.py](ifs.py)  |  iterated function systems  |  sierpinski.txt  barnsley.txt  coral.txt  culcita.txt  cyclosorus.txt  dragon.txt  fishbone.txt  floor.txt  koch.txt  spiral.txt  swirl.txt  tree.txt  zigzag.txt  
2.2.5  |  [bernoulli.py](bernoulli.py)  |  Bernoulli trials  |  –
2.3.1  |  [euclid.py](euclid.py)  |  Euclid's algorithm  |  –
2.3.2  |  [towersofhanoi.py](towersofhanoi.py)  |  towers of Hanoi  |  –
2.3.3  |  [beckett.py](beckett.py)  |  Gray code  |  –
2.3.4  |  [htree.py](htree.py)  |  recursive graphics  |  –
2.3.5  |  [brownian.py](brownian.py)  |  Brownian bridge  |  –
2.4.1  |  [percolationv.py](percolationv.py)  |  vertical percolation detection  |  test5.txt  test8.txt  
2.4.2  |  [percolationio.py](percolationio.py)  |  percolation support functions  |  –
2.4.3  |  [visualizev.py](visualizev.py)  |  vertical percolation visualization client  |  –
2.4.4  |  [estimatev.py](estimatev.py)  |  vertical percolation probability estimate  |  –
2.4.5  |  [percolation.py](percolation.py)  |  percolation detection  |  test5.txt  test8.txt  
2.4.6  |  [visualize.py](visualize.py)  |  percolation visualization client  |  –
...
4.5.3  |  [separation.py](separation.py)  |  shortest-paths client  |  routes.txt  movies.txt  
